        ...
        db.collection("teams").document(teamId)
            ...
            .addOnSuccessListener { doc ->
                if (doc.exists()) {
                    ...
                    val members = _selectedParticipants.value.toMutableList()
                    members.add(userEmail) // Add the creator
                    ...
                    db.collection("teams").document(teamId)
                        ...
                        .addOnSuccessListener {
                            _feedback.value = "Team '$name' for $sport created successfully! Waiting for admin approval."
                            _loading.value = false
                            // Reset selections
                            _teamName.value = ""
